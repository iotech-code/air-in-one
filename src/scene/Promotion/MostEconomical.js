                ...
                <ScrollView style={{ backgroundColor: 'white' }}>
                    ...
                    <View style={[styles.container, styles.mt_1, { marginBottom: 20 }]}>
                        ...
                        <View style={{ marginVertical: hp('2%'), flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                            ...
                            <Text style={styleScoped.textTitle}>ถูกที่สุด</Text>
                        </View>
                        ...
                        <View style={{ marginVertical: hp('2%') }}>
                            <Text style={{ fontFamily: defaultTheme.FONT.FONT_FAMILY, fontSize: hp('2%'), color: '#CECDCD' }}>รายการสินค้าที่ถูกที่สุด...</Text>
                        </View>
